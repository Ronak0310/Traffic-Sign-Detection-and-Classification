    ...
    def runInference(self):
        ...
        while True:
            ...
            if writer is None:
                ...
                writer = cv2.VideoWriter(self.output, fourcc, 25,
        ...
        Capture.release()
        writer.release()
        print('Average FPS:', round((f / t), 1))
        
    
    def parse_opt():
        parser = argparse.ArgumentParser()
        parser.add_argument('--input', type=str, default=None, help='Path to input file(s):(.mp4)/(.mkv)')
